...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-end sm:items-end lg:items-center justify-center overflow-hidden"
    >
      {/* Background Image */}
      <div
      ...
      {/* Content */}
      <div className="relative z-10 container mx-auto px-4 text-center pb-12 sm:mt96 lg:pb-0">
        <div className="max-w-4xl mx-auto">
          {/* Logo Badge */}
          <div className="flex justify-center mb-6 sm:mt-50">
            <div className="flex flex-row items-center space-x-3 bg-card/90 backdrop-blur-sm rounded-full px-6 py-3 shadow-soft animate-fade-in">
              ...
              <span className="font-heading text-lg font-semibold text-primary whitespace-nowrap">
                Greenoak Wellness Centre
              </span>
            </div>
          </div>

          {/* Main Heading */}
          <h1 className="font-heading text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-card mb-6 animate-slide-up">
            Your Mental Health
          ...
          {/* Subtitle */}
          <p
            className="text-lg sm:text-xl md:text-2xl text-card/90 mb-8 max-w-2xl mx-auto leading-relaxed animate-fade-in"
            style={{ animationDelay: "0.3s" }}
          >
            Professional therapy and counseling services to help you flourish
          ...
          >
            ...
            <Button
              ...
              className="border-card bg-card text-primary px-8 py-4 text-lg font-semibold"
            >
              Learn More
            </Button>
          </div>
          ...
          {/* Trust Indicators */}
          <div
            className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto animate-fade-in"
